...
constructor() { }
 ...
 getStates() {
     return [
        ...
        new State(16, 2, 'Dhaka'),
        new State(17, 2, 'Chittagong'),
        new State(18, 2, 'Rangpur'),
        new State(19, 2, 'Dinajpur'),
        new State(20, 2, 'Barisal'),
        new State(21, 2, 'Shylhet'),
        new State(22, 2, 'Rajshahi'),
        new State(23, 2, 'Bogura'),
        new State(24, 2, 'Manikgonj'),
        new State(25, 2, 'Thakurgao'),
